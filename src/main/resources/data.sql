...
INSERT INTO users (username, password, enabled) values('user', '{bcrypt}$2a$10$818zL6Pqr4wiLvEDLWdcX.zLZfT5i9t4kxPStcQs9XrNjLQoE7CDe', true);
INSERT INTO users  (username, password, enabled) values('admin', '{bcrypt}$2a$10$818zL6Pqr4wiLvEDLWdcX.zLZfT5i9t4kxPStcQs9XrNjLQoE7CDe', true);
