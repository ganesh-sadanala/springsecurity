package com.ganesh.lil.adminweb.web;
...
import com.ganesh.lil.adminweb.data.repository.CustomerRepository;
import com.ganesh.lil.adminweb.data.repository.OrderRepository;
...
public class CustomerController {
    ...
    public String getUser(@PathVariable("id")long customerId, Principal principal, Model model){
        ...
        if(principal instanceof UsernamePasswordAuthenticationToken){
            ...
            if(auth.get()){
                Iterable<Order> orderIterable=this.orderRepository.findAllByCustomerId(customerId);
